    ...
    public class RentalConfiguration : IEntityTypeConfiguration<Rental>
    {
        public void Configure(EntityTypeBuilder<Rental> builder)
        {
            ...
            builder.HasData(
                ...
                new Rental { Id=5, CustomerId=3, MovieCopyId=6, RentalDate = new DateTime(2023, 01, 11, 9, 50, 0), ReturnDate = new DateTime(2023, 01, 12, 14, 40, 0) },
                new Rental { Id=5, CustomerId=3, MovieCopyId=7, RentalDate = new DateTime(2023, 01, 13, 16, 50, 0) },
                new Rental { Id=5, CustomerId=3, MovieCopyId=8, RentalDate = new DateTime(2023, 01, 14, 18, 50, 0), ReturnDate = new DateTime(2023, 01, 16, 13, 50, 0) }
            );
